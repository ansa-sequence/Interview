...
## 39. Какие специальные функции-члены может генерировать сам компилятор? Напишите их сигнатуру.
...
## 40. Какие отличия у std::array и std::vector?
...
Forked from : https://github.com/dariaemacs/InverviewQuestions
